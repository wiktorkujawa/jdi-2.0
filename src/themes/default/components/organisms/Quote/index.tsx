    ...
    <section id={blockName || undefined} className="c-quote-block lg:my-16 my-10">
      <div className="o-container o-container--md">
        <blockquote className="quote-block my-8 p-6 border-l-4 border-primary bg-gray-50">
          {decoration && <div className="quote-decoration text-4xl text-primary mb-2">&ldquo;</div>}
          <p className="quote-text text-lg italic mb-4">{quote}</p>
          <footer className="quote-author text-sm font-semibold text-gray-600">— {author}</footer>
        </blockquote>
      </div>
    </section>
  )
